    ...
    <div class="container-fluid col-lg-12 col-md-12 col-sm-12 co-xs-12 file-preview no-padding">
        ...
        <ul>
            ...
            <li>
                ...
                <a href="{{ route('document.download-file', ['nIdDocument' => $oDocument->id_document, 'sDocumentName' => $oDocument->document_name]) }}" class="btn btn-primary">{{ trans('messages.download') }}</a>
        ...
        @else
        <iframe src="{{$sDisplayUrl}}" frameborder='0' width="100%" height="100%"></iframe>
        @endif
    </div>
    <footer>
