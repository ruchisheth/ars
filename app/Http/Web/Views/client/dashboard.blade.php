      ...
      <div class="col-md-4 col-sm-6 col-xs-12">
            ...
            <div class="info-box">
               <div class="info-box-content">
                  ...
                  <span class="info-box-detail">
                     <span>{{ trans('messages.assignment_status.scheduled') }}</span>
                     <span class="info-box-number">
                        {{ $nScheduledAssignmentCount }}
                     </span>
                  </span>
                  <span class="info-box-detail">
                     <span>{{ trans('messages.assignment_status.completed') }}</span>
                     <span class="info-box-number">
                        {{ $nCompletedAssignmentCount }}
                     </span>
                  </span>
               </div>
            </div>
       ...
       <div class="col-md-4 col-sm-6 col-xs-12">
         ...
         <div class="col-md-10">
            <div class="info-box">
               <div class="info-box-content">
                  <span class="info-box-text">{{ trans('messages.sites') }}</span>
                  <span class="info-box-detail">
                     <span>{{ trans('messages.open') }}</span>
                     <span class="info-box-number">
                        {{ $nOpenSiteCount }}
                     </span>
                  </span>
