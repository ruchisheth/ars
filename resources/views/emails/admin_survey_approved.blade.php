									...
									<tbody>
										<tr>
											<td style="font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;font-size:16px;line-height:26px;color:#666666;" class="m_7514756023630913654m_8194902932891523857body-">
												...
												The survey that you have submitted has been approved and your invoice has been forwarded to the Accounting department. 
												Any questions regarding payment from this point forward should be addressed with the Accounting department. 
												Thank you for your hard work. Below are the survey details.

												<!--<p>The survey-[{{ @$details['survey_code'] }}] you have submitted for, </p>-->
