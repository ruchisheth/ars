                                    ...
                                    <tbody>
                                        <tr>
                                            <td style="font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;font-size:25px;line-height:30px;color:#000000;font-weight:bold;text-align:center" class="m_7514756023630913654m_8194902932891523857headline-">
                                                Hello and Welcome to Alpha Rep Service {{ @$user->user_name  }}
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td style="font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;font-size:16px;line-height:26px;color:#666666;text-align:center" class="m_7514756023630913654m_8194902932891523857body-">
                                                Your account has been created  successfully!</b>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style=" padding:0 0 10px 0; font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;font-size:16px;line-height:26px;color:#666666;text-align:center" class="m_7514756023630913654m_8194902932891523857body-">
                                                Here are your login details
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <table style="margin-left:25%" cellspacing="5" cellpadding="0" border="0" align="center">
                                                    <tbody>
                                                        <tr>
                                                            <td style="text-align:right;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;font-size:16px;line-height:26px;color:#666666;" class="m_7514756023630913654m_8194902932891523857body-">
                                                                <b>Email:</b> 
                                                            </td>
                                                            <td style="text-align:left;padding:0 0 0 15px; font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;font-size:16px;line-height:26px;color:#666666;" class="m_7514756023630913654m_8194902932891523857body-">
                                                                {{ @$user->email  }}
                                                            </td>
                                                        </tr>
                                                        <tr>
                                        ...
                                        <tr>
                                            <td style="vertical-align:top;text-align:center">
                                                <table style="min-width:175px" cellspacing="0" cellpadding="0" border="0" bgcolor="#4cb7ff" align="center">
                                                    <tbody>
                                                        <tr>
                                                            <td style="background-color:#3C8DBC;padding:10px 20px 10px 20px;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;font-size:16px;line-height:22px;color:#ffffff;text-align:center" class="m_7514756023630913654m_8194902932891523857body-">
