          ...
          <div class="col-md-12">
            <div class="form-group">
              ...
              <label>  
                ...
                ['class'=>'minimal custom_radio']) }}
                <span class="rb_span">I'm unavailable or out of town</span>
              </label>
              <br>
              <label>  
                {{ Form::radio('reject_reason', '3', false,
                ['class'=>'minimal custom_radio']) }}
                <span class="rb_span">Does not pay enough</span>
              </label>
              <br>
              <label>  
                {{ Form::radio('reject_reason', '4', false,
                ['class'=>'minimal custom_radio']) }}
                <span class="rb_span">I do not wish to do jobs at this location</span>
              </label>
              <br>
              <label>  
