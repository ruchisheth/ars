...
<script type="text/javascript">
  ...
  var instruction_option = {
    ...
    $(document).ready(function () { 
      $("#attachment").fileinput(instruction_option);
      $("#offer_attachment").fileinput(instruction_option);
  ...
  $('#assignment_insturctions').on('hidden.bs.modal', function () {
    ...
    $("#attachment").fileinput('refresh',instruction_option);
    $("#offer_attachment").fileinput(instruction_option);
    ...
    success: function (res) {
      ...
      if(offer_attachment.length != 0){
        ...
        $("#offer_attachment").fileinput('refresh',
        {
          ...
          $("#offer_attachment").fileinput('refresh', instruction_option);
        } 
      }
    });
}
